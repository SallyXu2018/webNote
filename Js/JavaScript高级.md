...
对于浅拷贝来说，比如一个数组，只要我们修改了一个拷贝数组，那么原数组也会改变。因为它们引用的是一个地址数据，拷贝的时候并没有给b数组创造独立的内存，只是把a数组的指向数据的指针拷贝给了b。而深拷贝与其相反，将会给b数组创造一个独立的内存，并且将a数组的内容一一拷贝进来，两者互不影响。
...
var str1 = "123123@xx.com,fangfang@valuedopinions.cn 286669312@qq.com 2、emailenglish@emailenglish.englishtown.com 286669312@qq.com...";
...
//replace方法
var str3="sally你好啊，你好啊哈哈哈哈哈哈哈，还是你好啊啊";
str3=str3.replace(/你好啊/g,"你好棒啊");
console.log(str3);

// var str4="   hi   hello   hey        ,      ";
// str4=str4.trim();
// console.log("========"+str4+"==========");
var str4="   hi   hello   hey        ,      ";
...
//所有的Hh都替换成s
// var str5="HSDJIhHHHhjhhhhjjhsd";
// str5=str5.replace(/[h]/ig,"S");
// console.log(str5);
var reg=/[h]/ig;
var str5="HSDJIhHHHhjhhhhjjhsd";
str5=str5.replace(reg,"S");
console.log(str5);



//exec方法
var str6="中国移动：10086，中国联通：10010，中国电信：10000";
//把里面的数字全部显示出来
var reg1=/\d{5}/g;
var array1=reg1.exec(str6);
// console.log(array1);
// console.log(reg1.exec(str6));
// console.log(reg1.exec(str6));
while (array1!=null){
    console.log(array1[0]);
    array1=reg1.exec(str6)
}
```
...
console.log(arr.length);//真数组的长度是可变的
console.log("-----------------------");
...
obj[3]=1000;
console.log(obj.length);//3 伪数组的长度是不可变的
...
f1(10,10,20,20,30,30);
```

## 真数组可以使用数组的方法伪数组不可以使用数组的方法
...
f2(10,10);//TypeError: arguments.forEach is not a function ,arguments是伪数组
```
